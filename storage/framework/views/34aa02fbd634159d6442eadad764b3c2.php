        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a href="<?php echo e(route('admin.users.create')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                        + Add User
                    </a>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $activeUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form action="<?php echo e(route('admin.users.destroy', $user)); ?>" method="POST" class="inline ml-4" onsubmit="return confirm('Move this user to trash?');">
                                                <?php echo csrf_field(); ?>
            ...
            <div x-data="{ open: false }" class="mt-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200 cursor-pointer" @click="open = !open">
                        <div class="flex justify-between items-center">
                            <h3 class="text-lg font-medium text-gray-900">
                                ...
                                <span class="ml-2 text-sm text-gray-500">(<?php echo e($trashedUsers->count()); ?>)</span>
                            </h3>
                    ...
                    <div x-show="open" x-transition class="p-6 text-gray-900 border-t border-gray-200">
                        <?php if($trashedUsers->isNotEmpty()): ?>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $trashedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="bg-red-50">
                                            <td class="px-6 py-4 whitespace-nowrap"><s><?php echo e($user->name); ?></s></td>
                                            <td class="px-6 py-4 whitespace-nowrap"><s><?php echo e($user->email); ?></s></td>
                                            <td class="px-6 py-4 whitespace-nowrap"><?php echo e($user->deleted_at->format('d M Y, H:i')); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
...
<?php /**PATH C:\laragon\www\room-booking\resources\views/admin/users/index.blade.php ENDPATH**/ ?>